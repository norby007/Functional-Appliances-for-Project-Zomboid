...
function SiloGeneratorFix:perform()
	...
	if scrapItemE ~= nil then
		...
		self.generator:getModData()['Condition'] = (self.generator:getModData()['Condition'] + 4 + (1*(self.character:getPerkLevel(Perks.Electricity))/2))
	...
	elseif scrapItemM ~= nil then
		...
		self.generator:getModData()['Condition'] = (self.generator:getModData()['Condition'] + 4 + (1*(self.character:getPerkLevel(Perks.Mechanics))/2))
